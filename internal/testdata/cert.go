...
// GetClientCertificatePaths returns the paths to client's certificate and key
func GetClientCertificatePaths() (string, string) {
	return path.Join(certPath, "client.pem"), path.Join(certPath, "client.key")
}
